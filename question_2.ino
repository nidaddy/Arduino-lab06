...
byte colPins[KEY_COLS] = {6,7,8,9};	   // 按鍵模組，行1~4接腳。
byte rowPins[KEY_ROWS] = {2,3,4,5}; // 按鍵模組，列1~4接腳。 
int tune[] = {NOTE_G4, NOTE_G4, NOTE_E4, NOTE_D4, NOTE_E4, NOTE_A3, NOTE_D4, NOTE_E4, NOTE_G4, NOTE_E4, NOTE_D4,NOTE_G4, NOTE_G4, NOTE_E4, NOTE_D4, NOTE_E4};
// 初始化Keypad物件
